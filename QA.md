...
- Deployed API on https://moteur-check-fable.vercel.app: `/api/read` with the bill (2.9 s) and `/api/tariff` for 2026-08 (13.6 s, live-matched) with matching Origin header. Cross-origin POST returns 403, GET returns 405. CSP, X-Frame-Options and Permissions-Policy headers present.
